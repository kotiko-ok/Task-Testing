...
$stmt = $conn->prepare("SELECT * FROM `checklists`ORDER BY id_checklist DESC;
");
$stmt->execute();
            ...
            <div class="container">
                <div class="content">
                    <div class="content__block">
                        <h1 class="title">список проектов</h1>
                    </div>
                    <div class="content__block">
    ...
    ?>
                            ...
                            <div class="project" data-id_creator="<?=$row['id_creator']?>">
                                <div class="project__block project__blockdis">
                                    ...
                                    <div class="project__title"><a href="task.php?n=<?=$row['id_checklist']?>"><?=$row['name']?></a></div>
                                ...
                                <div class="project__block">
                                    ...
                                    <div class="project__status status<?=$row['id_status']?>" title="Не пройден">
